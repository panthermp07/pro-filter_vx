...
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/+ZYPevL2d9k45ZDll')
TUTORIAL = environ.get("TUTORIAL", "https://t.me/links_tutorialbypp/32")
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/links_tutorialbypp/32")

# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 3600)) # Add time in seconds
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
MAX_BTN = int(environ.get('MAX_BTN', 10))
LANGUAGES = [language.lower() for language in environ.get('LANGUAGES', 'bengali hindi english telugu tamil kannada malayalam marathi').split()]
